###------ Data cleaning case study - MBTA
##----Importing the dataset
# Load readxl
library(readxl)

# Import mbta.xlsx and skip first row: mbta
mbta<- read_excel("C:/R_Practice/R_Datacamp/Data cleaning/mbta.xlsx", skip=1)
...
###----------- View summary in order to perform exploratory analysis
